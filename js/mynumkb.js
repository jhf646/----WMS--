(function(exports) {
    var KeyBoard = function(input, options) {
        ...
        if (document.getElementById(DIV_ID)) {
            document.getElementById("jp").removeChild(document.getElementById(DIV_ID));
        }
        ...
        cssStr += '#' + TABLE_ID + '{text-align:center;width:100%;height:240px;background-color:#FFF;margin-top: 10px;border-top:1px solid #ddd;border-right:1px solid #ddd;}';
        ...
        tableStr += '<tr><td style="background-color:#D3D9DF;">删除</td><td>0</td>';
        tableStr += '<td style="background-color:#D3D9DF;">清空</td></tr>';
        tableStr += '</table>';
        ...
        document.getElementById("jp").appendChild(this.el);
    };
